        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <Button size="lg" className="min-w-[160px] bg-amber-500 hover:bg-amber-600">
                View Projects <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
              <Button size="lg" variant="outline" className="min-w-[160px] border-amber-500/20 hover:bg-amber-500/10">
                Get in Touch
              </Button>
            </div>
          ...
          >
            <div className="relative mx-auto w-[280px] h-[280px]">
              ...
              <img
                ...
                alt="Profile"
                className="rounded-full w-[260px] h-[260px] object-cover border-4 border-amber-500/20 shadow-xl relative z-10 mx-auto"
              />
            </div>
          </motion.div>
        </div>
